...
################################################################
# This is a generated script based on design: als_llrf_mts
#
...
# source als_llrf_mts_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axil_evr, axil_llrf, frontend_control_axi, pulse_gen, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, axis_adder, dac_streamer
...
proc create_hier_cell_hier_dac_play { parentCell nameHier } {
  ...
  # Create instance: dac_streamer_0, and set properties
  set block_name dac_streamer
  set block_cell_name dac_streamer_0
  if { [catch {set dac_streamer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dac_streamer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axis_adder_0_m_axis [get_bd_intf_pins axis_adder_0/m_axis] [get_bd_intf_pins axis_clock_converter_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net dac_streamer_0_BRAM_A [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins dac_streamer_0/BRAM_A]
  connect_bd_intf_net -intf_net dac_streamer_0_m_axis [get_bd_intf_pins axis_adder_0/s0_axis] [get_bd_intf_pins dac_streamer_0/m_axis]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net s1_axis_1 [get_bd_intf_pins s1_axis] [get_bd_intf_pins axis_adder_0/s1_axis]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_adder_0/axis_aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins dac_streamer_0/axis_aresetn]
  connect_bd_net -net Net1 [get_bd_pins axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_adder_0/axis_aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins dac_streamer_0/axis_clk]
  ...
  connect_bd_net -net enable_1 [get_bd_pins enable] [get_bd_pins dac_streamer_0/enable]
  connect_bd_net -net pulse_length_1 [get_bd_pins pulse_length] [get_bd_pins dac_streamer_0/n_rows]
  connect_bd_net -net trigger_1 [get_bd_pins trigger] [get_bd_pins dac_streamer_0/trigger]
...
proc create_hier_cell_hier_dac_cap { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins adc_capture_0/s_axis] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
...
proc create_hier_cell_m33 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m33() - Empty argument(s)!"}
     return
  }
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins axis_clk] [get_bd_pins adc_capture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins adc_capture_0/axis_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins adc_capture_0/trigger]
...
proc create_hier_cell_m32 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m32() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m31 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m31() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m30 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m30() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m23 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m23() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m22 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m22() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m21 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m21() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m20 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m20() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m13 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m13() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m12 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m12() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m11 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m11() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m10 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m10() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m03 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m03() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m02 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m02() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_m01 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m01() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins adc_capture_0/s_axis] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins axis_clk] [get_bd_pins adc_capture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  connect_bd_net -net clk_wiz_adc1_clk_out1 [get_bd_pins aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net pulse_length_1 [get_bd_pins pulse_length] [get_bd_pins adc_capture_0/n_rows]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins adc_capture_0/axis_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins adc_capture_0/trigger]
...
proc create_hier_cell_m00 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_m00() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I trig_cap
  create_bd_pin -dir O -type intr write_done_0
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins axis_clk] [get_bd_pins adc_capture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  connect_bd_net -net adc_capture_0_write_done [get_bd_pins write_done_0] [get_bd_pins adc_capture_0/write_done]
  connect_bd_net -net clk_wiz_adc1_clk_out1 [get_bd_pins aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net pulse_length_1 [get_bd_pins pulse_length] [get_bd_pins adc_capture_0/n_rows]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins adc_capture_0/axis_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins adc_capture_0/trigger]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  create_hier_cell_hier_dac_cap $hier_obj hier_dac_cap

  # Create instance: hier_dac_play
  create_hier_cell_hier_dac_play $hier_obj hier_dac_play
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins hier_dac_play/S_AXI] [get_bd_intf_pins interconnect/M00_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins hier_dac_cap/S_AXI] [get_bd_intf_pins interconnect/M01_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins S_AXI] [get_bd_intf_pins interconnect/S00_AXI]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M08_AXIS [get_bd_intf_pins axis_broadcaster_0/M08_AXIS] [get_bd_intf_pins hier_dac_cap/S_AXIS]
  ...
  connect_bd_intf_net -intf_net s1_axis_1 [get_bd_intf_pins s1_axis] [get_bd_intf_pins hier_dac_play/s1_axis]

  # Create port connections
  connect_bd_net -net S_AXI_CLK_1 [get_bd_pins S_AXI_CLK] [get_bd_pins hier_dac_cap/axis_clk] [get_bd_pins hier_dac_play/axis_clk] [get_bd_pins interconnect/ACLK] [get_bd_pins interconnect/M00_ACLK] [get_bd_pins interconnect/M01_ACLK] [get_bd_pins interconnect/S00_ACLK]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  # Create instance: m00
  create_hier_cell_m00 $hier_obj m00

  # Create instance: m01
  create_hier_cell_m01 $hier_obj m01

  # Create instance: m02
  create_hier_cell_m02 $hier_obj m02

  # Create instance: m03
  create_hier_cell_m03 $hier_obj m03

  # Create instance: m10
  create_hier_cell_m10 $hier_obj m10

  # Create instance: m11
  create_hier_cell_m11 $hier_obj m11

  # Create instance: m12
  create_hier_cell_m12 $hier_obj m12

  # Create instance: m13
  create_hier_cell_m13 $hier_obj m13

  # Create instance: m20
  create_hier_cell_m20 $hier_obj m20

  # Create instance: m21
  create_hier_cell_m21 $hier_obj m21

  # Create instance: m22
  create_hier_cell_m22 $hier_obj m22

  # Create instance: m23
  create_hier_cell_m23 $hier_obj m23

  # Create instance: m30
  create_hier_cell_m30 $hier_obj m30

  # Create instance: m31
  create_hier_cell_m31 $hier_obj m31

  # Create instance: m32
  create_hier_cell_m32 $hier_obj m32

  # Create instance: m33
  create_hier_cell_m33 $hier_obj m33
  ...
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins interconnect/M00_AXI] [get_bd_intf_pins m00/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins interconnect/M01_AXI] [get_bd_intf_pins m01/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins interconnect/M02_AXI] [get_bd_intf_pins m02/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_4 [get_bd_intf_pins interconnect/M03_AXI] [get_bd_intf_pins m03/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_5 [get_bd_intf_pins interconnect/M04_AXI] [get_bd_intf_pins m10/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_6 [get_bd_intf_pins interconnect/M05_AXI] [get_bd_intf_pins m11/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_7 [get_bd_intf_pins interconnect/M06_AXI] [get_bd_intf_pins m12/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_8 [get_bd_intf_pins interconnect/M07_AXI] [get_bd_intf_pins m13/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_9 [get_bd_intf_pins interconnect/M08_AXI] [get_bd_intf_pins m20/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_10 [get_bd_intf_pins interconnect/M09_AXI] [get_bd_intf_pins m21/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_11 [get_bd_intf_pins interconnect/M10_AXI] [get_bd_intf_pins m22/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_12 [get_bd_intf_pins interconnect/M11_AXI] [get_bd_intf_pins m23/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_13 [get_bd_intf_pins interconnect/M12_AXI] [get_bd_intf_pins m30/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_14 [get_bd_intf_pins interconnect/M13_AXI] [get_bd_intf_pins m31/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_15 [get_bd_intf_pins interconnect/M14_AXI] [get_bd_intf_pins m32/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_16 [get_bd_intf_pins interconnect/M15_AXI] [get_bd_intf_pins m33/S_AXI]
  connect_bd_intf_net -intf_net m00_M00_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins m00/M00_AXIS]
  connect_bd_intf_net -intf_net m01_M00_AXIS [get_bd_intf_pins M01_AXIS] [get_bd_intf_pins m01/M00_AXIS]
  ...
  connect_bd_net -net axis_clk_1 [get_bd_pins S_AXI_CLK] [get_bd_pins interconnect/ACLK] [get_bd_pins interconnect/M00_ACLK] [get_bd_pins interconnect/M01_ACLK] [get_bd_pins interconnect/M02_ACLK] [get_bd_pins interconnect/M03_ACLK] [get_bd_pins interconnect/M04_ACLK] [get_bd_pins interconnect/M05_ACLK] [get_bd_pins interconnect/M06_ACLK] [get_bd_pins interconnect/M07_ACLK] [get_bd_pins interconnect/M08_ACLK] [get_bd_pins interconnect/M09_ACLK] [get_bd_pins interconnect/M10_ACLK] [get_bd_pins interconnect/M11_ACLK] [get_bd_pins interconnect/M12_ACLK] [get_bd_pins interconnect/M13_ACLK] [get_bd_pins interconnect/M14_ACLK] [get_bd_pins interconnect/M15_ACLK] [get_bd_pins interconnect/S00_ACLK] [get_bd_pins m00/axis_clk] [get_bd_pins m01/axis_clk] [get_bd_pins m02/axis_clk] [get_bd_pins m03/axis_clk] [get_bd_pins m10/axis_clk] [get_bd_pins m11/axis_clk] [get_bd_pins m12/axis_clk] [get_bd_pins m13/axis_clk] [get_bd_pins m20/axis_clk] [get_bd_pins m21/axis_clk] [get_bd_pins m22/axis_clk] [get_bd_pins m23/axis_clk] [get_bd_pins m30/axis_clk] [get_bd_pins m31/axis_clk] [get_bd_pins m32/axis_clk] [get_bd_pins m33/axis_clk]
  connect_bd_net -net m00_write_done_0 [get_bd_pins write_done_0] [get_bd_pins m00/write_done_0]
  connect_bd_net -net pulse_length_1 [get_bd_pins pulse_length] [get_bd_pins m00/pulse_length] [get_bd_pins m01/pulse_length] [get_bd_pins m02/pulse_length] [get_bd_pins m03/pulse_length] [get_bd_pins m10/pulse_length] [get_bd_pins m11/pulse_length] [get_bd_pins m12/pulse_length] [get_bd_pins m13/pulse_length] [get_bd_pins m20/pulse_length] [get_bd_pins m21/pulse_length] [get_bd_pins m22/pulse_length] [get_bd_pins m23/pulse_length] [get_bd_pins m30/pulse_length] [get_bd_pins m31/pulse_length] [get_bd_pins m32/pulse_length] [get_bd_pins m33/pulse_length]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins interconnect/ARESETN] [get_bd_pins interconnect/M00_ARESETN] [get_bd_pins interconnect/M01_ARESETN] [get_bd_pins interconnect/M02_ARESETN] [get_bd_pins interconnect/M03_ARESETN] [get_bd_pins interconnect/M04_ARESETN] [get_bd_pins interconnect/M05_ARESETN] [get_bd_pins interconnect/M06_ARESETN] [get_bd_pins interconnect/M07_ARESETN] [get_bd_pins interconnect/M08_ARESETN] [get_bd_pins interconnect/M09_ARESETN] [get_bd_pins interconnect/M10_ARESETN] [get_bd_pins interconnect/M11_ARESETN] [get_bd_pins interconnect/M12_ARESETN] [get_bd_pins interconnect/M13_ARESETN] [get_bd_pins interconnect/M14_ARESETN] [get_bd_pins interconnect/M15_ARESETN] [get_bd_pins interconnect/S00_ARESETN] [get_bd_pins m00/s_axi_aresetn] [get_bd_pins m01/s_axi_aresetn] [get_bd_pins m02/s_axi_aresetn] [get_bd_pins m03/s_axi_aresetn] [get_bd_pins m10/s_axi_aresetn] [get_bd_pins m11/s_axi_aresetn] [get_bd_pins m12/s_axi_aresetn] [get_bd_pins m13/s_axi_aresetn] [get_bd_pins m20/s_axi_aresetn] [get_bd_pins m21/s_axi_aresetn] [get_bd_pins m22/s_axi_aresetn] [get_bd_pins m23/s_axi_aresetn] [get_bd_pins m30/s_axi_aresetn] [get_bd_pins m31/s_axi_aresetn] [get_bd_pins m32/s_axi_aresetn] [get_bd_pins m33/s_axi_aresetn]
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net interconnect_M00_AXI [get_bd_intf_pins freqcnt_gpio/S_AXI] [get_bd_intf_pins interconnect/M00_AXI]
  connect_bd_intf_net -intf_net interconnect_M01_AXI [get_bd_intf_pins MTSclkwiz/s_axi_lite] [get_bd_intf_pins interconnect/M01_AXI]
  connect_bd_intf_net -intf_net s_axi_lite_1 [get_bd_intf_pins s_axi_lite] [get_bd_intf_pins interconnect/S00_AXI]
...
proc create_root_design { parentCell } {
  ...
  set AMS_SYSREF [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_usp_rf_data_converter:diff_pins_rtl:1.0 AMS_SYSREF ]
  ...
  set ADCIO_02 [ create_bd_port -dir I ADCIO_02 ]
  ...
  set ADCIO_06 [ create_bd_port -dir I ADCIO_06 ]
  ...
  set ADCIO_10 [ create_bd_port -dir I ADCIO_10 ]
  ...
  set ADCIO_14 [ create_bd_port -dir I ADCIO_14 ]
  ...
  set DACIO_02 [ create_bd_port -dir I DACIO_02 ]
  ...
  set DACIO_06 [ create_bd_port -dir I DACIO_06 ]
  ...
  set block_cell_name axil_llrf_0
  if { [catch {set axil_llrf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axil_llrf_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: frontend_control_axi_0, and set properties
  set block_name frontend_control_axi
  set block_cell_name frontend_control_axi_0
  if { [catch {set frontend_control_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $frontend_control_axi_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: rf_interconnect, and set properties
  set rf_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 rf_interconnect ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_OBS_Fabric_Freq {0.0} \
  ...
  # Create instance: xpm_cdc_irq, and set properties
  set xpm_cdc_irq [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 xpm_cdc_irq ]
  set_property -dict [ list \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net S_AXI1_1 [get_bd_intf_pins clocktreeMTS/s_axi_lite] [get_bd_intf_pins control_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net S_AXIS_M33_1 [get_bd_intf_pins receiver/S_AXIS_M33] [get_bd_intf_pins rfdc/m33_axis]
  ...
  connect_bd_intf_net -intf_net axil_llrf_0_m_axis [get_bd_intf_pins axil_llrf_0/m_axis] [get_bd_intf_pins transmitter/s1_axis]
  ...
  connect_bd_intf_net -intf_net control_interconnect_M03_AXI [get_bd_intf_pins control_interconnect/M03_AXI] [get_bd_intf_pins frontend_control_axi_0/s0_axi]
  connect_bd_intf_net -intf_net control_interconnect_M04_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins control_interconnect/M04_AXI]
  ...
  connect_bd_intf_net -intf_net receiver_M00_AXIS [get_bd_intf_pins axil_llrf_0/s0_axis] [get_bd_intf_pins receiver/M00_AXIS]
  connect_bd_intf_net -intf_net receiver_M01_AXIS [get_bd_intf_pins axil_llrf_0/s1_axis] [get_bd_intf_pins receiver/M01_AXIS]
  connect_bd_intf_net -intf_net rf_interconnect_M00_AXI [get_bd_intf_pins axil_llrf_0/s_axi] [get_bd_intf_pins rf_interconnect/M00_AXI]
  ...
  connect_bd_intf_net -intf_net sysref_in_0_1 [get_bd_intf_ports AMS_SYSREF] [get_bd_intf_pins rfdc/sysref_in]
  connect_bd_intf_net -intf_net transmitter_M00_AXIS [get_bd_intf_pins rfdc/s00_axis] [get_bd_intf_pins transmitter/M00_AXIS]
  connect_bd_intf_net -intf_net transmitter_M01_AXIS [get_bd_intf_pins rfdc/s02_axis] [get_bd_intf_pins transmitter/M01_AXIS]
  connect_bd_intf_net -intf_net transmitter_M02_AXIS [get_bd_intf_pins rfdc/s10_axis] [get_bd_intf_pins transmitter/M02_AXIS]
  connect_bd_intf_net -intf_net transmitter_M03_AXIS [get_bd_intf_pins rfdc/s12_axis] [get_bd_intf_pins transmitter/M03_AXIS]
  connect_bd_intf_net -intf_net transmitter_M04_AXIS [get_bd_intf_pins rfdc/s20_axis] [get_bd_intf_pins transmitter/M04_AXIS]
  ...
  connect_bd_intf_net -intf_net vin1_23_1 [get_bd_intf_ports vin1_23] [get_bd_intf_pins rfdc/vin1_23]
  ...
  connect_bd_intf_net -intf_net vin3_01_1 [get_bd_intf_ports vin3_01] [get_bd_intf_pins rfdc/vin3_01]
  connect_bd_intf_net -intf_net vin3_23_1 [get_bd_intf_ports vin3_23] [get_bd_intf_pins rfdc/vin3_23]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins rf_interconnect/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  # Create port connections
  connect_bd_net -net ADCIO_02_1 [get_bd_ports ADCIO_02] [get_bd_pins frontend_control_axi_0/spi4_miso]
  connect_bd_net -net ADCIO_06_1 [get_bd_ports ADCIO_06] [get_bd_pins frontend_control_axi_0/spi5_miso]
  connect_bd_net -net ADCIO_10_1 [get_bd_ports ADCIO_10] [get_bd_pins frontend_control_axi_0/spi6_miso]
  connect_bd_net -net ADCIO_14_1 [get_bd_ports ADCIO_14] [get_bd_pins frontend_control_axi_0/spi7_miso]
  connect_bd_net -net DACIO_02_1 [get_bd_ports DACIO_02] [get_bd_pins frontend_control_axi_0/spi0_miso]
  connect_bd_net -net DACIO_06_1 [get_bd_ports DACIO_06] [get_bd_pins frontend_control_axi_0/spi1_miso]
  connect_bd_net -net DACIO_10_1 [get_bd_ports DACIO_10] [get_bd_pins frontend_control_axi_0/spi2_miso]
  connect_bd_net -net DACIO_14_1 [get_bd_ports DACIO_14] [get_bd_pins frontend_control_axi_0/spi3_miso]
  connect_bd_net -net RFegressReset_peripheral_aresetn [get_bd_pins axil_llrf_0/s_axi_aresetn] [get_bd_pins clocktreeMTS/egress_aresetn] [get_bd_pins receiver/s_axi_aresetn] [get_bd_pins rf_interconnect/ARESETN] [get_bd_pins rf_interconnect/M00_ARESETN] [get_bd_pins rf_interconnect/M01_ARESETN] [get_bd_pins rf_interconnect/M02_ARESETN] [get_bd_pins rf_interconnect/S00_ARESETN] [get_bd_pins transmitter/S_AXI_RESETN]
  ...
  connect_bd_net -net TRIG_IN_1 [get_bd_ports TRIG_IN] [get_bd_pins axil_llrf_0/ext_trigger_in]
  connect_bd_net -net axil_evr_0_event1_dsp [get_bd_pins axil_evr_0/event1_dsp] [get_bd_pins axil_llrf_0/evr_trigger_in] [get_bd_pins pulse_gen_0/trigger]
  connect_bd_net -net axil_llrf_0_pulse_length [get_bd_pins axil_llrf_0/pulse_length] [get_bd_pins transmitter/pulse_length]
  connect_bd_net -net axil_llrf_0_rf_permit_out [get_bd_pins axil_llrf_0/rf_permit_out] [get_bd_pins transmitter/enable]
  connect_bd_net -net axil_rf_control_0_trigger_out [get_bd_pins axil_llrf_0/trigger_out] [get_bd_pins receiver/trig_cap] [get_bd_pins transmitter/trig_cap]
  ...
  connect_bd_net -net clocktreeMTS_clkRFdiv2 [get_bd_pins axil_evr_0/dsp_clk] [get_bd_pins axil_llrf_0/clk] [get_bd_pins clocktreeMTS/clkRFdiv2] [get_bd_pins pulse_gen_0/clk] [get_bd_pins receiver/S_AXI_CLK] [get_bd_pins rf_interconnect/ACLK] [get_bd_pins rf_interconnect/M00_ACLK] [get_bd_pins rf_interconnect/M01_ACLK] [get_bd_pins rf_interconnect/M02_ACLK] [get_bd_pins rf_interconnect/S00_ACLK] [get_bd_pins transmitter/S_AXI_CLK] [get_bd_pins xpm_cdc_irq/src_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clocktreeMTS_interrupt [get_bd_pins clocktreeMTS/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net frontend_control_axi_0_spi0_clk [get_bd_ports DACIO_01] [get_bd_pins frontend_control_axi_0/spi0_clk]
  connect_bd_net -net frontend_control_axi_0_spi0_cs_n [get_bd_ports DACIO_03] [get_bd_pins frontend_control_axi_0/spi0_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi0_mosi [get_bd_ports DACIO_00] [get_bd_pins frontend_control_axi_0/spi0_mosi]
  connect_bd_net -net frontend_control_axi_0_spi1_clk [get_bd_ports DACIO_05] [get_bd_pins frontend_control_axi_0/spi1_clk]
  connect_bd_net -net frontend_control_axi_0_spi1_cs_n [get_bd_ports DACIO_07] [get_bd_pins frontend_control_axi_0/spi1_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi1_mosi [get_bd_ports DACIO_04] [get_bd_pins frontend_control_axi_0/spi1_mosi]
  connect_bd_net -net frontend_control_axi_0_spi2_clk [get_bd_ports DACIO_09] [get_bd_pins frontend_control_axi_0/spi2_clk]
  connect_bd_net -net frontend_control_axi_0_spi2_cs_n [get_bd_ports DACIO_11] [get_bd_pins frontend_control_axi_0/spi2_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi2_mosi [get_bd_ports DACIO_08] [get_bd_pins frontend_control_axi_0/spi2_mosi]
  connect_bd_net -net frontend_control_axi_0_spi3_clk [get_bd_ports DACIO_13] [get_bd_pins frontend_control_axi_0/spi3_clk]
  connect_bd_net -net frontend_control_axi_0_spi3_cs_n [get_bd_ports DACIO_15] [get_bd_pins frontend_control_axi_0/spi3_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi3_mosi [get_bd_ports DACIO_12] [get_bd_pins frontend_control_axi_0/spi3_mosi]
  connect_bd_net -net frontend_control_axi_0_spi4_clk [get_bd_ports ADCIO_01] [get_bd_pins frontend_control_axi_0/spi4_clk]
  connect_bd_net -net frontend_control_axi_0_spi4_cs_n [get_bd_ports ADCIO_03] [get_bd_pins frontend_control_axi_0/spi4_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi4_mosi [get_bd_ports ADCIO_00] [get_bd_pins frontend_control_axi_0/spi4_mosi]
  connect_bd_net -net frontend_control_axi_0_spi5_clk [get_bd_ports ADCIO_05] [get_bd_pins frontend_control_axi_0/spi5_clk]
  connect_bd_net -net frontend_control_axi_0_spi5_cs_n [get_bd_ports ADCIO_07] [get_bd_pins frontend_control_axi_0/spi5_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi5_mosi [get_bd_ports ADCIO_04] [get_bd_pins frontend_control_axi_0/spi5_mosi]
  connect_bd_net -net frontend_control_axi_0_spi6_clk [get_bd_ports ADCIO_09] [get_bd_pins frontend_control_axi_0/spi6_clk]
  connect_bd_net -net frontend_control_axi_0_spi6_cs_n [get_bd_ports ADCIO_11] [get_bd_pins frontend_control_axi_0/spi6_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi6_mosi [get_bd_ports ADCIO_08] [get_bd_pins frontend_control_axi_0/spi6_mosi]
  connect_bd_net -net frontend_control_axi_0_spi7_clk [get_bd_ports ADCIO_13] [get_bd_pins frontend_control_axi_0/spi7_clk]
  connect_bd_net -net frontend_control_axi_0_spi7_cs_n [get_bd_ports ADCIO_15] [get_bd_pins frontend_control_axi_0/spi7_cs_n]
  connect_bd_net -net frontend_control_axi_0_spi7_mosi [get_bd_ports ADCIO_12] [get_bd_pins frontend_control_axi_0/spi7_mosi]
  connect_bd_net -net hier_irq_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axil_evr_0/s_axi_aresetn] [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins control_interconnect/ARESETN] [get_bd_pins control_interconnect/M00_ARESETN] [get_bd_pins control_interconnect/M01_ARESETN] [get_bd_pins control_interconnect/M02_ARESETN] [get_bd_pins control_interconnect/M03_ARESETN] [get_bd_pins control_interconnect/M04_ARESETN] [get_bd_pins control_interconnect/S00_ARESETN] [get_bd_pins frontend_control_axi_0/axi_aresetn] [get_bd_pins rfdc/s_axi_aresetn]
  connect_bd_net -net pulse_gen_0_pulse_out [get_bd_ports GPIO_LED_0_LS] [get_bd_pins pulse_gen_0/pulse_out]
  connect_bd_net -net receiver_write_done_0 [get_bd_pins receiver/write_done_0] [get_bd_pins xpm_cdc_irq/src_pulse]
  connect_bd_net -net rfdc_irq [get_bd_pins rfdc/irq] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axil_llrf_0/rf_permit_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins pulse_gen_0/high_len] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins receiver/pulse_length] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xpm_cdc_gen_0_dest_pulse [get_bd_pins xlconcat_0/In2] [get_bd_pins xpm_cdc_irq/dest_pulse]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axil_evr_0/s_axi_aclk] [get_bd_pins clocktreeMTS/s_axi_aclk] [get_bd_pins control_interconnect/ACLK] [get_bd_pins control_interconnect/M00_ACLK] [get_bd_pins control_interconnect/M01_ACLK] [get_bd_pins control_interconnect/M02_ACLK] [get_bd_pins control_interconnect/M03_ACLK] [get_bd_pins control_interconnect/M04_ACLK] [get_bd_pins control_interconnect/S00_ACLK] [get_bd_pins frontend_control_axi_0/axi_aclk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins xpm_cdc_irq/dest_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0xA0240000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axil_llrf_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs frontend_control_axi_0/s0_axi/reg0] -force
