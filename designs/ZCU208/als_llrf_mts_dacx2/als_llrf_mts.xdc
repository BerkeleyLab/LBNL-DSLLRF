...
# -------------- -------------- -------------- -------------- -------------- -------------- -------
# 437.5 MHz PL_CLK
create_clock -period 2.286 -name PL_CLK_clk -waveform {0.000 1.000} [get_ports {PL_CLK_clk_p}]
...
set_input_delay -clock [get_clocks PL_CLK_clk] -max -add_delay 1.163 [get_ports PL_SYSREF_clk_p]
