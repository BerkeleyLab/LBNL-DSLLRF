...
# module references:
# axil_evr, axil_llrf, pulse_gen, freq_count, freq_count, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, adc_capture, axis_adder, dac_streamer
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins hier_dac_play/S_AXI]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  ...
  # Create port connections
  connect_bd_net -net S_AXI_CLK_1 [get_bd_pins S_AXI_CLK] [get_bd_pins hier_dac_play/axis_clk]
  connect_bd_net -net S_AXI_RESETN_1 [get_bd_pins S_AXI_RESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins hier_dac_play/s_axi_aresetn]
  connect_bd_net -net dac_clk_1 [get_bd_pins aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins hier_dac_play/aclk]
  ...
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins hier_dac_play/trigger]
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {70.257} \
   CONFIG.CLKOUT1_MATCHED_ROUTING {true} \
   CONFIG.CLKOUT1_PHASE_ERROR {71.849} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {437.5} \
   CONFIG.CLKOUT2_DRIVES {Buffer} \
   CONFIG.CLKOUT2_JITTER {80.369} \
   CONFIG.CLKOUT2_MATCHED_ROUTING {true} \
   CONFIG.CLKOUT2_PHASE_ERROR {71.849} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {218.75} \
  ...
  connect_bd_net -net IBUFDS_SYSREF_IBUF_OUT [get_bd_pins IBUFDS_SYSREF/IBUF_OUT] [get_bd_pins freq_count_1/f_in] [get_bd_pins synchronizeSYSREF/src_in]
  ...
  connect_bd_net -net freq_count_1_frequency1 [get_bd_pins freq_count_1/frequency] [get_bd_pins freqcnt_gpio/gpio2_io_i]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Fabric_Freq {437.500} \
   CONFIG.ADC0_Multi_Tile_Sync {true} \
   CONFIG.ADC0_OBS_Fabric_Freq {0.0} \
   CONFIG.ADC0_Outclk_Freq {27.344} \
   CONFIG.ADC0_Refclk_Freq {3500.000} \
   CONFIG.ADC0_Sampling_Rate {3.5} \
   CONFIG.ADC1_Clock_Dist {1} \
   CONFIG.ADC1_Clock_Source {1} \
   CONFIG.ADC1_Enable {1} \
   CONFIG.ADC1_Fabric_Freq {437.500} \
   CONFIG.ADC1_Multi_Tile_Sync {true} \
   CONFIG.ADC1_Outclk_Freq {27.344} \
   CONFIG.ADC1_Refclk_Freq {3500.000} \
   CONFIG.ADC1_Sampling_Rate {3.5} \
   CONFIG.ADC2_Clock_Dist {0} \
   CONFIG.ADC2_Clock_Source {1} \
   CONFIG.ADC2_Enable {1} \
   CONFIG.ADC2_Fabric_Freq {437.500} \
   CONFIG.ADC2_Multi_Tile_Sync {true} \
   CONFIG.ADC2_Outclk_Freq {27.344} \
   CONFIG.ADC2_Refclk_Freq {3500.000} \
   CONFIG.ADC2_Sampling_Rate {3.5} \
   CONFIG.ADC3_Clock_Source {1} \
   CONFIG.ADC3_Enable {1} \
   CONFIG.ADC3_Fabric_Freq {437.500} \
   CONFIG.ADC3_Multi_Tile_Sync {true} \
   CONFIG.ADC3_Outclk_Freq {27.344} \
   CONFIG.ADC3_Refclk_Freq {3500.000} \
   CONFIG.ADC3_Sampling_Rate {3.5} \
   ...
   CONFIG.DAC0_Fabric_Freq {437.500} \
   CONFIG.DAC0_Multi_Tile_Sync {true} \
   CONFIG.DAC0_Outclk_Freq {54.688} \
   CONFIG.DAC0_PLL_Enable {false} \
   CONFIG.DAC0_Refclk_Freq {7000.000} \
   CONFIG.DAC0_Sampling_Rate {7} \
   CONFIG.DAC1_Clock_Source {6} \
   CONFIG.DAC1_Enable {1} \
   CONFIG.DAC1_Fabric_Freq {437.500} \
   CONFIG.DAC1_Multi_Tile_Sync {true} \
   CONFIG.DAC1_Outclk_Freq {54.688} \
   CONFIG.DAC1_PLL_Enable {false} \
   CONFIG.DAC1_Refclk_Freq {7000.000} \
   CONFIG.DAC1_Sampling_Rate {7} \
   CONFIG.DAC2_Clock_Dist {1} \
   CONFIG.DAC2_Enable {1} \
   CONFIG.DAC2_Fabric_Freq {437.500} \
   CONFIG.DAC2_Multi_Tile_Sync {true} \
   CONFIG.DAC2_Outclk_Freq {54.688} \
   CONFIG.DAC2_PLL_Enable {false} \
   CONFIG.DAC2_Refclk_Freq {7000.000} \
   CONFIG.DAC2_Sampling_Rate {7} \
   CONFIG.DAC3_Clock_Source {6} \
   CONFIG.DAC3_Enable {1} \
   CONFIG.DAC3_Fabric_Freq {437.500} \
   CONFIG.DAC3_Multi_Tile_Sync {true} \
   CONFIG.DAC3_Outclk_Freq {54.688} \
   CONFIG.DAC3_PLL_Enable {false} \
   CONFIG.DAC3_Refclk_Freq {7000.000} \
   CONFIG.DAC3_Sampling_Rate {7} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_net -net axil_rf_control_0_pulse_length_out [get_bd_pins axil_llrf_0/pulse_length] [get_bd_pins receiver/pulse_length] [get_bd_pins transmitter/pulse_length]
  connect_bd_net -net axil_rf_control_0_trigger_out [get_bd_ports TRIG_OUT] [get_bd_pins axil_llrf_0/trigger_out] [get_bd_pins receiver/trig_cap] [get_bd_pins transmitter/trig_cap]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axil_llrf_0/ext_trigger_in] [get_bd_pins axil_llrf_0/rf_permit_in] [get_bd_pins xlconstant_0/dout]
