...
# Synthesis Guidance
# -------------- -------------- -------------- -------------- -------------- -------------- -------
set_property BLOCK_SYNTH.RETIMING 1 [get_cells mimo_mts_iq_i/rfdc/*]
set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells mimo_mts_iq_i/rfdc/*]
set_property BLOCK_SYNTH.RETIMING 1 [get_cells mimo_mts_iq_i/receiver*/m*/axis_dwidth_converter_0/*]
set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells mimo_mts_iq_i/receiver*/m*/axis_dwidth_converter_0/*]
...
set_clock_groups -asynchronous \
        -group [get_clocks -of_objects [get_pins mimo_mts_iq_i/zynq_ultra_ps_e_0/pl_clk0]] \
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets mimo_mts_iq_i/clocktreeMTS/IBUFDS_PL_CLK/U0/USE_IBUFDS.GEN_IBUFDS[0].IBUFDS_I/O]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets mimo_mts_iq_i/clocktreeMTS/BUFG_PL_CLK/U0/BUFG_O[0]]

set_false_path -from [get_pins {mimo_mts_iq_i/clocktreeMTS/RFegressReset/U0/ACTIVE_LOW_PR_OUT_DFF[*].*/C}]
