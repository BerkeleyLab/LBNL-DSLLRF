...
################################################################
# This is a generated script based on design: pulser_am
#
...
# source pulser_am_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# freq_count_axi, ADCRAMcapture, ADCRAMcapture, ADCRAMcapture, ADCRAMcapture, ADCRAMcapture, diag_readback
...
proc create_hier_cell_hier_dac_cap { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 31 -to 0 cap_addr_0
  create_bd_pin -dir O cap_en_0
  create_bd_pin -dir O -from 31 -to 0 cap_wdata_0
  create_bd_pin -dir O cap_we_0
  create_bd_pin -dir I -type clk s_axi_aclk_diag
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I -type rst s_axi_aresetn_diag
  create_bd_pin -dir O -from 31 -to 0 tdata_2f
  create_bd_pin -dir O -from 31 -to 0 tdata_2w
  create_bd_pin -dir I trig_cap
  create_bd_pin -dir O trig_cap_posedge_out_0
  create_bd_pin -dir O tvalid_out
  ...
  # Create instance: tdata_2f_slice, and set properties
  set tdata_2f_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 tdata_2f_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
  ...
  # Create instance: tdata_2w_slice, and set properties
  set tdata_2w_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 tdata_2w_slice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_WIDTH {256} \
   CONFIG.DOUT_WIDTH {32} \
  ...
  connect_bd_net -net ADCRAMcapture_0_cap_addr [get_bd_pins cap_addr_0] [get_bd_pins ADCRAMcapture_0/cap_addr]
  connect_bd_net -net ADCRAMcapture_0_cap_en [get_bd_pins cap_en_0] [get_bd_pins ADCRAMcapture_0/cap_en]
  connect_bd_net -net ADCRAMcapture_0_cap_wdata [get_bd_pins cap_wdata_0] [get_bd_pins ADCRAMcapture_0/cap_wdata]
  connect_bd_net -net ADCRAMcapture_0_cap_we [get_bd_pins cap_we_0] [get_bd_pins ADCRAMcapture_0/cap_we]
  ...
  connect_bd_net -net ADCRAMcapture_0_trig_cap_posedge_out [get_bd_pins trig_cap_posedge_out_0] [get_bd_pins ADCRAMcapture_0/trig_cap_posedge_out]
  ...
  connect_bd_net -net ADCRAMcapture_0_tvalid_counter [get_bd_pins ADCRAMcapture_0/tvalid_counter] [get_bd_pins diag_readback_0/tvalid_counter]
  connect_bd_net -net ADCRAMcapture_0_tvalid_out [get_bd_pins tvalid_out] [get_bd_pins ADCRAMcapture_0/tvalid_out]
  ...
  connect_bd_net -net axis_clock_converter_0_m_axis_tdata [get_bd_pins ADCRAMcapture_0/CAP_AXIS_tdata] [get_bd_pins axis_clock_converter_0/m_axis_tdata] [get_bd_pins tdata_2f_slice/Din]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tdata [get_bd_pins axis_clock_converter_0/s_axis_tdata] [get_bd_pins axis_dwidth_converter_0/m_axis_tdata] [get_bd_pins tdata_2w_slice/Din]
  ...
  connect_bd_net -net tdata_2f_slice_Dout [get_bd_pins tdata_2f] [get_bd_pins tdata_2f_slice/Dout]
  connect_bd_net -net tdata_2w_slice_Dout [get_bd_pins tdata_2w] [get_bd_pins tdata_2w_slice/Dout]
...
# Hierarchical cell: hier_adc20_Q_cap
proc create_hier_cell_hier_adc20_Q_cap { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_adc20_Q_cap() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net axis_clk_1 [get_bd_pins axis_clk] [get_bd_pins ADCRAMcapture_0/axis_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_clock_converter_0/m_axis_aclk]
  connect_bd_net -net axis_clock_converter_0_m_axis_tdata [get_bd_pins ADCRAMcapture_0/CAP_AXIS_tdata] [get_bd_pins axis_clock_converter_0/m_axis_tdata]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tdata [get_bd_pins axis_clock_converter_0/s_axis_tdata] [get_bd_pins axis_dwidth_converter_0/m_axis_tdata]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins ADCRAMcapture_0/trig_cap]
...
# Hierarchical cell: hier_adc20_I_cap
proc create_hier_cell_hier_adc20_I_cap { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_adc20_I_cap() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: hier_adc10_Q_cap
proc create_hier_cell_hier_adc10_Q_cap { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_adc10_Q_cap() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: hier_adc10_I_cap
proc create_hier_cell_hier_adc10_I_cap { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_hier_adc10_I_cap() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 PL_CLK_buf
  create_bd_pin -dir O -from 0 -to 0 UserSYSREF
  create_bd_pin -dir O -type clk clkRF
  create_bd_pin -dir O -from 0 -to 0 -type rst clkRF_aresetn
  create_bd_pin -dir O -type clk clkRFdiv2
  create_bd_pin -dir O -from 0 -to 0 -type rst clkRFdiv2_aresetn
  ...
  connect_bd_net -net RFegressReset_peripheral_aresetn [get_bd_pins clkRFdiv2_aresetn] [get_bd_pins RFegressReset/peripheral_aresetn]
  connect_bd_net -net RFingressReset_peripheral_aresetn [get_bd_pins clkRF_aresetn] [get_bd_pins RFingressReset/peripheral_aresetn]
  ...
  connect_bd_net -net util_ds_buf_0_BUFG_O [get_bd_pins PL_CLK_buf] [get_bd_pins BUFG_PL_CLK/BUFG_O] [get_bd_pins MTSclkwiz/clk_in1] [get_bd_pins synchronizeSYSREF/src_clk]
...
proc create_root_design { parentCell } {
  ...
  set PL_CLK [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 -portmaps { \
   CLK_N { physical_name PL_CLK_clk_n direction I left 0 right 0 } \
   CLK_P { physical_name PL_CLK_clk_p direction I left 0 right 0 } \
   } \
  PL_CLK ]
  set_property -dict [ list \
  ...
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports PL_CLK]

  set PL_SYSREF [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 -portmaps { \
   CLK_N { physical_name PL_SYSREF_clk_n direction I left 0 right 0 } \
   CLK_P { physical_name PL_SYSREF_clk_p direction I left 0 right 0 } \
   } \
  PL_SYSREF ]
  set_property -dict [ list \
   CONFIG.CAN_DEBUG {false} \
  ...
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports PL_SYSREF]

  set adc2_clk_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 adc2_clk_0 ]

  set clk104_clk_spi_mux_sel [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 -portmaps { \
   TRI_O { physical_name clk104_clk_spi_mux_sel_tri_o direction O left 1 right 0 } \
   } \
  clk104_clk_spi_mux_sel ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports clk104_clk_spi_mux_sel]
  ...
  # Create instance: freq_count_axi_0, and set properties
  set block_name freq_count_axi
  set block_cell_name freq_count_axi_0
  if { [catch {set freq_count_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $freq_count_axi_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.UNK_CLK_DIFF {BYPASS} \
 ] $freq_count_axi_0

  # Create instance: gpio_control
  create_hier_cell_gpio_control [current_bd_instance .] gpio_control

  # Create instance: hier_adc10_I_cap
  create_hier_cell_hier_adc10_I_cap [current_bd_instance .] hier_adc10_I_cap

  # Create instance: hier_adc10_Q_cap
  create_hier_cell_hier_adc10_Q_cap [current_bd_instance .] hier_adc10_Q_cap

  # Create instance: hier_adc20_I_cap
  create_hier_cell_hier_adc20_I_cap [current_bd_instance .] hier_adc20_I_cap

  # Create instance: hier_adc20_Q_cap
  create_hier_cell_hier_adc20_Q_cap [current_bd_instance .] hier_adc20_Q_cap
  ...
  # Create instance: pulser_axis_0, and set properties
  set pulser_axis_0 [ create_bd_cell -type ip -vlnv user.org:user:pulser_axis:1.0 pulser_axis_0 ]
  set_property -dict [ list \
   CONFIG.CW {32} \
   CONFIG.MODE_IQ {true} \
   CONFIG.MODULATED {true} \
   CONFIG.STREAM_SAMPLES {4} \
 ] $pulser_axis_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC_NCO_Freq10 {0.125} \
   CONFIG.ADC_NCO_Freq20 {0.125} \
   ...
   CONFIG.DAC_NCO_Freq10 {0.125} \
   CONFIG.DAC_NCO_Freq20 {0.125} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins hier_adc20_I_cap/S_AXI] [get_bd_intf_pins internalRAM_interconnect/M04_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins hier_adc20_Q_cap/S_AXI] [get_bd_intf_pins internalRAM_interconnect/M05_AXI]
  connect_bd_intf_net -intf_net adc2_clk_0_1 [get_bd_intf_ports adc2_clk_0] [get_bd_intf_pins rfdc/adc2_clk]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins rfdc/s20_axis]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins hier_dac_cap/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M02_AXIS [get_bd_intf_pins axis_broadcaster_0/M02_AXIS] [get_bd_intf_pins rfdc/s10_axis]
  ...
  connect_bd_intf_net -intf_net control_interconnect_M05_AXI [get_bd_intf_pins control_interconnect/M05_AXI] [get_bd_intf_pins debug_bridge_0/S_AXI]
  connect_bd_intf_net -intf_net control_interconnect_M06_AXI [get_bd_intf_pins control_interconnect/M06_AXI] [get_bd_intf_pins freq_count_axi_0/s_axi]
  connect_bd_intf_net -intf_net dac2_clk_0_1 [get_bd_intf_ports dac2_clk_0] [get_bd_intf_pins rfdc/dac2_clk]
  connect_bd_intf_net -intf_net internalRAM_interconnect_M00_AXI [get_bd_intf_pins internalRAM_interconnect/M00_AXI] [get_bd_intf_pins pulser_axis_0/S_AXI]
  connect_bd_intf_net -intf_net internalRAM_interconnect_M03_AXI [get_bd_intf_pins internalRAM_interconnect/M03_AXI] [get_bd_intf_pins rfdc/s_axi]
  connect_bd_intf_net -intf_net internalRAM_interconnect_M06_AXI [get_bd_intf_pins hier_adc10_I_cap/S_AXI] [get_bd_intf_pins internalRAM_interconnect/M06_AXI]
  connect_bd_intf_net -intf_net internalRAM_interconnect_M07_AXI [get_bd_intf_pins hier_adc10_Q_cap/S_AXI] [get_bd_intf_pins internalRAM_interconnect/M07_AXI]
  ...
  connect_bd_intf_net -intf_net pulser_axis_0_DAC_stream [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins pulser_axis_0/DAC_stream]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_pins hier_adc10_I_cap/S_AXIS] [get_bd_intf_pins rfdc/m10_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m11_axis [get_bd_intf_pins hier_adc10_Q_cap/S_AXIS] [get_bd_intf_pins rfdc/m11_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m20_axis [get_bd_intf_pins hier_adc20_I_cap/S_AXIS] [get_bd_intf_pins rfdc/m20_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m21_axis [get_bd_intf_pins hier_adc20_Q_cap/S_AXIS] [get_bd_intf_pins rfdc/m21_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout10 [get_bd_intf_ports vout10_0] [get_bd_intf_pins rfdc/vout10]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout20 [get_bd_intf_ports vout20_0] [get_bd_intf_pins rfdc/vout20]
  connect_bd_intf_net -intf_net vin1_01_0_1 [get_bd_intf_ports vin1_01_0] [get_bd_intf_pins rfdc/vin1_01]
  connect_bd_intf_net -intf_net vin2_01_0_1 [get_bd_intf_ports vin2_01_0] [get_bd_intf_pins rfdc/vin2_01]
  ...
  # Create port connections
  connect_bd_net -net RFegressReset_peripheral_aresetn [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins clocktreeMTS/clkRFdiv2_aresetn] [get_bd_pins hier_adc10_I_cap/s_axi_aresetn] [get_bd_pins hier_adc10_Q_cap/s_axi_aresetn] [get_bd_pins hier_adc20_I_cap/s_axi_aresetn] [get_bd_pins hier_adc20_Q_cap/s_axi_aresetn] [get_bd_pins hier_dac_cap/s_axi_aresetn] [get_bd_pins hier_dac_cap/s_axi_aresetn_diag] [get_bd_pins internalRAM_interconnect/ARESETN] [get_bd_pins internalRAM_interconnect/M00_ARESETN] [get_bd_pins internalRAM_interconnect/M01_ARESETN] [get_bd_pins internalRAM_interconnect/M02_ARESETN] [get_bd_pins internalRAM_interconnect/M03_ARESETN] [get_bd_pins internalRAM_interconnect/M04_ARESETN] [get_bd_pins internalRAM_interconnect/M05_ARESETN] [get_bd_pins internalRAM_interconnect/M06_ARESETN] [get_bd_pins internalRAM_interconnect/M07_ARESETN] [get_bd_pins internalRAM_interconnect/S00_ARESETN] [get_bd_pins pulser_axis_0/s_axi_aresetn] [get_bd_pins rfdc/m1_axis_aresetn] [get_bd_pins rfdc/m2_axis_aresetn] [get_bd_pins rfdc/s1_axis_aresetn] [get_bd_pins rfdc/s2_axis_aresetn] [get_bd_pins rfdc/s_axi_aresetn]
  connect_bd_net -net axi_gpio_bram_cap_gpio_io_o [get_bd_ports GPIO_LED7_LS] [get_bd_pins gpio_control/dest_out] [get_bd_pins pulser_axis_0/evr_trig]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins hier_adc10_I_cap/aclk] [get_bd_pins hier_adc10_Q_cap/aclk] [get_bd_pins hier_adc20_I_cap/aclk] [get_bd_pins hier_adc20_Q_cap/aclk] [get_bd_pins hier_dac_cap/aclk] [get_bd_pins pulser_axis_0/DAC_stream_clk] [get_bd_pins rfdc/m1_axis_aclk] [get_bd_pins rfdc/m2_axis_aclk] [get_bd_pins rfdc/s1_axis_aclk] [get_bd_pins rfdc/s2_axis_aclk]
  connect_bd_net -net clk_wiz_adc0_clk_out2 [get_bd_pins clocktreeMTS/clkRFdiv2] [get_bd_pins gpio_control/dest_clk] [get_bd_pins hier_adc10_I_cap/axis_clk] [get_bd_pins hier_adc10_Q_cap/axis_clk] [get_bd_pins hier_adc20_I_cap/axis_clk] [get_bd_pins hier_adc20_Q_cap/axis_clk] [get_bd_pins hier_dac_cap/axis_clk] [get_bd_pins hier_dac_cap/s_axi_aclk_diag] [get_bd_pins internalRAM_interconnect/ACLK] [get_bd_pins internalRAM_interconnect/M00_ACLK] [get_bd_pins internalRAM_interconnect/M01_ACLK] [get_bd_pins internalRAM_interconnect/M02_ACLK] [get_bd_pins internalRAM_interconnect/M03_ACLK] [get_bd_pins internalRAM_interconnect/M04_ACLK] [get_bd_pins internalRAM_interconnect/M05_ACLK] [get_bd_pins internalRAM_interconnect/M06_ACLK] [get_bd_pins internalRAM_interconnect/M07_ACLK] [get_bd_pins internalRAM_interconnect/S00_ACLK] [get_bd_pins pulser_axis_0/s_axi_aclk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clocktreeMTS_PL_CLK_buf [get_bd_pins clocktreeMTS/PL_CLK_buf] [get_bd_pins freq_count_axi_0/unk_clk_p]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins control_interconnect/ARESETN] [get_bd_pins control_interconnect/M00_ARESETN] [get_bd_pins control_interconnect/M01_ARESETN] [get_bd_pins control_interconnect/M02_ARESETN] [get_bd_pins control_interconnect/M03_ARESETN] [get_bd_pins control_interconnect/M04_ARESETN] [get_bd_pins control_interconnect/M05_ARESETN] [get_bd_pins control_interconnect/M06_ARESETN] [get_bd_pins control_interconnect/S00_ARESETN] [get_bd_pins debug_bridge_0/s_axi_aresetn] [get_bd_pins freq_count_axi_0/s_axi_aresetn] [get_bd_pins gpio_control/s_axi_aresetn]
  connect_bd_net -net pulser_axis_0_pulse_en [get_bd_ports GPIO_LED3_LS] [get_bd_pins pulser_axis_0/pulse_en]
  connect_bd_net -net pulser_axis_0_trig_out_stream_clk [get_bd_pins hier_adc10_I_cap/trig_cap] [get_bd_pins hier_adc10_Q_cap/trig_cap] [get_bd_pins hier_adc20_I_cap/trig_cap] [get_bd_pins hier_adc20_Q_cap/trig_cap] [get_bd_pins hier_dac_cap/trig_cap] [get_bd_pins pulser_axis_0/trig_out_stream_clk]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins freq_count_axi_0/ref_clk_n] [get_bd_pins freq_count_axi_0/unk_clk_n] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clocktreeMTS/s_axi_aclk] [get_bd_pins control_interconnect/ACLK] [get_bd_pins control_interconnect/M00_ACLK] [get_bd_pins control_interconnect/M01_ACLK] [get_bd_pins control_interconnect/M02_ACLK] [get_bd_pins control_interconnect/M03_ACLK] [get_bd_pins control_interconnect/M04_ACLK] [get_bd_pins control_interconnect/M05_ACLK] [get_bd_pins control_interconnect/M06_ACLK] [get_bd_pins control_interconnect/S00_ACLK] [get_bd_pins debug_bridge_0/s_axi_aclk] [get_bd_pins freq_count_axi_0/s_axi_aclk] [get_bd_pins gpio_control/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins freq_count_axi_0/ref_clk_p] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc20_I_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc20_Q_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc10_I_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0080000 -range 0x00020000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_adc10_Q_cap/axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xA0101000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_dac_cap/diag_readback_0/s_axi/reg0] -force
  assign_bd_address -offset 0x80010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs freq_count_axi_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0100000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pulser_axis_0/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0xA0200000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rfdc/s_axi/Reg] -force
