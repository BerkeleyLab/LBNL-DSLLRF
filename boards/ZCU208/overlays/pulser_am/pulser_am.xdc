...
# Synthesis Guidance
# -------------- -------------- -------------- -------------- -------------- -------------- -------
#set_property BLOCK_SYNTH.RETIMING 1 [get_cells pulser_am_i/ddr4_0]
#set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells pulser_am_i/ddr4_0]
#set_property MAX_FANOUT 32 [get_cells {pulser_am_i/ddr4_0/inst/u_ddr4_mem_intfc/u_ddr_mc/bgr[1].u_ddr_mc_group/txn_fifo_output_reg[*]}]
#set_property MAX_FANOUT 32 [get_cells {pulser_am_i/ddr4_0/inst/u_ddr4_mem_intfc/u_ddr_mc/bgr[1].u_ddr_mc_group/cas_fifo_wptr[*]*}]
#set_property LOC MMCM_X0Y2 [get_cells -hier -filter {NAME =~ */u_ddr4_infrastructure/gen_mmcme*.u_mmcme_adv_inst}]

set_property BLOCK_SYNTH.RETIMING 1 [get_cells pulser_am_i/rfdc/*]
set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells pulser_am_i/rfdc/*]
set_property BLOCK_SYNTH.RETIMING 1 [get_cells pulser_am_i/hier_adc*/axis_dwidth_converter_0/*]
set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells pulser_am_i/hier_adc*/axis_dwidth_converter_0/*]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pulser_am_i/clocktreeMTS/IBUFDS_PL_CLK/U0/USE_IBUFDS.GEN_IBUFDS[0].IBUFDS_I/O]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets pulser_am_i/clocktreeMTS/BUFG_PL_CLK/U0/BUFG_O[0]]

set_false_path -from [get_ports reset]
#set_false_path -from [get_pins {pulser_am_i/gpio_control/axi_gpio_dac/U0/gpio_core_1/Not_Dual.gpio_Data_Out_reg[*]/C}]
set_false_path -from [get_pins {pulser_am_i/clocktreeMTS/RFegressReset/U0/ACTIVE_LOW_PR_OUT_DFF[*].*/C}]
